...
<div class="bg-slate-50 font-sans text-slate-900 pb-12 animate-[fadeIn_0.3s_ease-out]">
  
  <header class="bg-zinc-950 text-white pt-10 pb-28 px-6 sm:px-12 relative overflow-hidden shadow-2xl shadow-zinc-900/20">
  ...
  <main class="w-full max-w-[1400px] mx-auto px-4 sm:px-12 -mt-16 relative z-20">
