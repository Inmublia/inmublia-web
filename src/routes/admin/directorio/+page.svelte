...
<div class="flex-1 flex flex-col h-screen overflow-hidden bg-slate-50 font-sans text-slate-900 animate-[fadeIn_0.3s_ease-out]">
  
  <header class="bg-zinc-950 text-white pt-10 pb-28 px-6 sm:px-12 relative overflow-hidden shadow-2xl shadow-zinc-900/20 shrink-0 z-10">
  ...
  <main class="flex-1 overflow-y-auto relative z-20 scroll-smooth pb-24">
    <div class="w-full max-w-[1400px] mx-auto px-4 sm:px-12 -mt-16">
      ...
      {#if clientesInteligentes().length === 0}
        <div class="bg-white rounded-3xl border border-slate-200 p-16 text-center flex flex-col items-center justify-center">
