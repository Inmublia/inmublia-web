<script>
  ...
  import { 
    ...
    Compass, Play, Send, Download, MessageCircle
  } from 'lucide-svelte';
...
{#if !isBrochure}
  <a href="https://wa.me/{broker.whatsapp}?text=Hola,%20me%20interesa%20agendar%20un%20recorrido%20para:%20{propiedad.titulo}" target="_blank" class="fixed bottom-8 right-8 bg-[#25D366] text-white px-5 py-3 rounded-full shadow-[0_8px_30px_rgba(37,211,102,0.4)] hover:bg-[#1ebd5a] hover:scale-105 transition-all duration-300 z-[100] flex items-center gap-2" aria-label="Contactar por WhatsApp">
